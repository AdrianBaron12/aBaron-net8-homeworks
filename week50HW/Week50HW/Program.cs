using OOPADV.Exercise1;
using OOPADV.Exercise2;
using System;
using OOPADV.Exercise3;
using OOPADV.Exercise4;
using OOPADV.Exercise5;
using OOPADV.Exercise6;
using OOPADV.Exercise7;
using Week6.Exercise3;
...
StandardRoom room1 = new StandardRoom(1, 1000, BedType.SingleSize);
StandardRoom room2 = new StandardRoom(2, 1000, BedType.DoubleSize);
ExclusiveRoom room3 = new ExclusiveRoom(3, 1500, BedType.QueenSize, 700);
...
order.AddItem("Pizza", 10);
order.AddItem("Burger", 5);
order.AddItem("Salad", 10);
